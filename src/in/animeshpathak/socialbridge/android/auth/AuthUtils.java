...
package in.animeshpathak.socialbridge.android.auth;
...
public class AuthUtils {
  ...
  public static void refreshAuthToken(final Context context) {
    ...
    if (null == account) {
    	Log.d(TAG,"no accounts found, showing popup to user.");
      ...
      context.startActivity(accountListIntent);
    	...
    	Log.d(TAG,"Stored account found, Getting token now.");
        ...
        public void run(AccountManagerFuture<Bundle> future) {
          try {
            ...
            if (accountName != null && authToken != null) {
              ...
              Log.d(TAG, "starting activity now");
